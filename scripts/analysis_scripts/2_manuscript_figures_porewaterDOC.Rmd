...
pw_ec_all <- read_rds("~/GitHub/TEMPEST-1-porewater/processed data/TMP_PW_EC_15cm_2021-2024_L2.rds")
...
pw_ec %>%
  mutate(plot = factor(plot, levels = plot_order)) %>%
    ...
    geom_point()+
    geom_vline(xintercept = tmp1_doc_high,linetype="dashed",color="grey")+ 
    geom_vline(xintercept = tmp2_doc_high,linetype="dashed",color="grey")+ 
    geom_vline(xintercept = tmp3_doc_high,linetype="dashed",color="grey")+ 
