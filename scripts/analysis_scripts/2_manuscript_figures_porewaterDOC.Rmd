...
Figure1 <- ggarrange(Figure1a, Figure1b, Figure1c, ncol =1)

Figure1 <- ggarrange(Figure1a, Figure1c, ncol =1)
...
cowplot::save_plot("~/GitHub/TEMPEST-1-porewater/figures/manuscript_figures/Figure1_pw_exp_doc.png",Figure1, dpi=600, base_asp = 3.1)
