...
Generate for Figure 2 comparison with laboratory datasets. 
```{r doc avg stds}
...
baci_stats(dates_fticrms_avg_stats, var = relabund, plot = "Estuarine-water",  p_value_threshold = 0.05)
  
```
# pH
```{r load pH data}

ph <-  read_csv("~/GitHub/TEMPEST-1-porewater/processed data/for_google_drive/TMP_PW_pH_L1_2023.csv") 
...
filter(plot != "Control" | 
  ...
  filter(plot != "Estuarine-water" | 
    (plot == "Estuarine-water" & !evacuation_date %in% as.Date(c("2023-06-12", "2023-06-14", "2023-07-05", "2023-07-07", "2023-08-04", "2023-08-07","2023-09-29", "2023-10-02", "2023-12-05", "2023-12-08")))) %>%
    filter(plot != "Freshwater" | 
