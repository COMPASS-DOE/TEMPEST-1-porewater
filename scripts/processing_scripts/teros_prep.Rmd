...
teros_qc2 <- teros_qc1 %>% 
  mutate(value = case_when(research_name == "soil_EC_5cm" & location == "H6" & between(datetime_est, as.POSIXct("2023-01-04 13:00", tz = common_tz), as.POSIXct("2023-05-31 13:00", tz = common_tz)) ~ NA,
                           TRUE ~ value))
```
