...
teros_qc2_EC <- teros_qc1 %>% 
  mutate(value = case_when(research_name == "soil_EC_5cm" & Location_Inventory == "H6" & datetime_est %in% as.POSIXct(c("2022-02-20 22:30", "2022-02-21 09:00", "2022-12-03 13:45", 
