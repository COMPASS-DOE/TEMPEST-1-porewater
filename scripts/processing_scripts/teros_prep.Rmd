...
write_rds(weather_all_raw, "~/GitHub/TEMPEST-1-porewater/data_do_not_commit/2022-2023_teros_raw.rds")
```
...
write_csv(rain_qc1, "../TEMPEST-1-porewater/processed data/TMP_rain_2022-2023.csv")
...
write_csv(EC_L2, "../TEMPEST-1-porewater/processed data/TMP_PW_L2_EC15cm_2022-2023.csv")

saveRDS(EC_L2, "../TEMPEST-1-porewater/processed data/TMP_PW_L2_EC15cm_2022-2023.rds")
