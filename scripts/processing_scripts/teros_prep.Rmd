...
```{r scrub the sketch}
teros_qc2 <- teros_qc1 %>% 
  mutate(value = case_when(research_name == "soil_vwc_15cm" & location == "I5" & plot == "SW" & between(datetime_est, as.POSIXct("2023-01-04 13:00", tz = common_tz), as.POSIXct("2023-05-31 13:00", tz = common_tz)) ~ NA, TRUE ~ value))
```
...
write_csv(vwc_L2, "~/GitHub/TEMPEST-1-porewater/processed data/TMP_PW_L2_VWC_2022-2023.csv")

saveRDS(vwc_L2, "~/GitHub/TEMPEST-1-porewater/processed data/TMP_PW_L2_VWC_2022-2023.rds")
...
write_csv(EC_L2, "~/GitHub/TEMPEST-1-porewater/processed data/TMP_PW_L2_EC15cm_2022-2023.csv")

saveRDS(EC_L2, "~/GitHub/TEMPEST-1-porewater/processed data/TMP_PW_L2_EC15cm_2022-2023.rds")
