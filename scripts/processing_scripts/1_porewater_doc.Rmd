...
Include this if you are only running certain dates 
...
saveRDS(source_npoc_wflags_metadata, "../../processed data/TMP_SOURCE_NPOC_TDN_L1_TMP1TMP2.rds")

saveRDS(PW_npoc_wflags_metadata_pooled_only, "../../processed data/TMP_PW_POOL_NPOC_TDN_L1_May2022-Dec2023.rds")

```

2) Save the grid resolved data: 

```{r manuscript specific final write out of pw}
...
write_csv(for_fluxes, "../../processed data/TMP_PW_GRIDSONLY_NPOC_TDN_L1_May2022-Dec2023.csv")

saveRDS(for_fluxes, "../../processed data/TMP_PW_GRIDSONLY_NPOC_TDN_L1_May2022-Dec2023.rds")
```
